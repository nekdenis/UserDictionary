...
public class GeneratedSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_FILE_NAME = "simpledict.db";
    ...
    private static final String SQL_CREATE_TABLE_WORD = "CREATE TABLE IF NOT EXISTS "
            ...
            + WordColumns.ADDED_DATE + " INTEGER "
            + ", CONSTRAINT unique_name unique (original_word) on conflict replace"
            + " );";
