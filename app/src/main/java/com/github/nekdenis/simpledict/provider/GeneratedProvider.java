package com.github.nekdenis.simpledict.provider;
...
import com.github.nekdenis.simpledict.BuildConfig;
...
public class GeneratedProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.github.nekdenis.simpledict.provider";
    public static final String CONTENT_URI_BASE = "content://" + AUTHORITY;

    public static final String QUERY_NOTIFY = "QUERY_NOTIFY";
    public static final String QUERY_GROUP_BY = "QUERY_GROUP_BY";

    private static final int URI_TYPE_WORD = 0;
    private static final int URI_TYPE_WORD_ID = 1;
    ...
    static {
        URI_MATCHER.addURI(AUTHORITY, WordColumns.TABLE_NAME, URI_TYPE_WORD);
        URI_MATCHER.addURI(AUTHORITY, WordColumns.TABLE_NAME + "/#", URI_TYPE_WORD_ID);
    }

    protected GeneratedSQLiteOpenHelper mGeneratedSQLiteOpenHelper;
    ...
    public boolean onCreate() {
        ...
        mGeneratedSQLiteOpenHelper = GeneratedSQLiteOpenHelper.getInstance(getContext());
        return true;
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case URI_TYPE_WORD:
                return TYPE_CURSOR_DIR + WordColumns.TABLE_NAME;
            case URI_TYPE_WORD_ID:
                return TYPE_CURSOR_ITEM + WordColumns.TABLE_NAME;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long rowId = mGeneratedSQLiteOpenHelper.getWritableDatabase().insertOrThrow(table, null, values);
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        String table = uri.getLastPathSegment();
        SQLiteDatabase db = mGeneratedSQLiteOpenHelper.getWritableDatabase();
        int res = 0;
        db.beginTransaction();
        try {
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int res = mGeneratedSQLiteOpenHelper.getWritableDatabase().update(queryParams.table, values, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        QueryParams queryParams = getQueryParams(uri, selection, null);
        int res = mGeneratedSQLiteOpenHelper.getWritableDatabase().delete(queryParams.table, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        Cursor res = mGeneratedSQLiteOpenHelper.getReadableDatabase().query(queryParams.tablesWithJoins, projection, queryParams.selection, selectionArgs, groupBy,
    ...
    private QueryParams getQueryParams(Uri uri, String selection, String[] projection) {
        ...
        switch (matchedId) {
            case URI_TYPE_WORD:
            case URI_TYPE_WORD_ID:
                res.table = WordColumns.TABLE_NAME;
                res.tablesWithJoins = WordColumns.TABLE_NAME;
                res.orderBy = WordColumns.DEFAULT_ORDER;
                break;
